...
class MySqlOnEC2Stack(core.Stack):
    ...
    def __init__(
        ...
        **kwargs
        ...
        try:
            with open("mysql_to_rds/stacks/back_end/bootstrap_scripts/deploy_app.sh",
                      encoding="utf-8",
                      mode="r"
                      ) as f:
                user_data = f.read()
        ...
        output_1 = core.CfnOutput(
            ...
            description=f"Private IP of MySQLDB on EC2"
        )
        output_2 = core.CfnOutput(
            ...
            description=f"Login to the instance using Systems Manager and use curl to access the MySQL DB Instance"
        )
